...
// ابر (ثابت - بهبود یافته برای باران با رنگ خاکستری تیره مایل به آبی)
...
// قطره (حذف شده چون از CustomPainter استفاده می‌کنیم، اما برای سازگاری نگه می‌داریم و زیباتر می‌کنیم)
...
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <defs>
        <linearGradient id="dropGrad" x1="12" y1="2" x2="12" y2="18" gradientUnits="userSpaceOnUse">
