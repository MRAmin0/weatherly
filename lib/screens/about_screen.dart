      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const SingleChildScrollView(
            child: Text('''
🌈 نسخه 1.8.0
• هماهنگی کامل رنگ‌های رابط با ColorScheme (پس‌زمینه، سرچ‌بار و کارت AQI)  
• اضافه شدن پشتیبانی از رنگ پویا (Material You) و انتخاب دستی تم رابط کاربری  
• افزایش پالت رنگ‌های قابل انتخاب به ۱۲ رنگ اصلی متریال و بهبود نمایش وضعیت AQI  
