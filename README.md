...
### 🎨 رابط کاربری
- 🌈 **Material Design 3** با پشتیبانی کامل از Dynamic Color
...
[![Myket](https://img.shields.io/badge/دانلود_از-مایکت-00C853?style=for-the-badge&logo=android)](https://myket.ir/app/com.weathely.app)
...
**حجم فایل:** ~15 MB | **نسخه اندروید:** 5.0+ (API Level 21)
...
├── app_localizations.dart       # سیستم بین‌المللی‌سازی (i18n)
├── l10n/                        # فایل‌های ترجمه
...
│   ├── date_formatter.dart     # فرمت‌بندی تاریخ
│   └── weather_utils.dart      # توابع کمکی آب‌وهوا
└── weather_store.dart           # مدیریت وضعیت مرکزی (Provider)
...
1. فایل ARB جدید در پوشه `l10n/` ایجاد کنید (مثلاً `app_ar.arb` برای عربی)
...
- 🌦 **[Open-Meteo API](https://open-meteo.com/)** — دریافت داده‌های آب‌وهوا
- 📦 **[Provider](https://pub.dev/packages/provider)** — مدیریت State
- 🎨 **[Material Design 3](https://m3.material.io/)** — سیستم طراحی
- 🚀 **[Flutter](https://flutter.dev/)** — فریم‌ورک توسعه
...
- 🌐 وب‌سایت: [وب‌سایت خود را اینجا وارد کنید]
